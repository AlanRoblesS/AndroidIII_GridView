...
class MyPicsApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new MaterialApp(title: 'GridView',debugShowCheckedModeBanner: false, home: new PaginaPrincipal(title: 'Galeria de Imagenes de Robles')); //Fin de materialapp
  } //Fin de widget
